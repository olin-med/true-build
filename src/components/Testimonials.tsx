...
export default function Testimonials() {
  return (
    <div id="testimonials" className="flex flex-col items-center">
      ...
      <div className="flex flex-col sm:flex-row gap-y-8 sm:gap-x-8 w-full px-4">
        <div className="bg-[#fff6ed] text-[#304F8C] p-8 sm:p-12 w-full flex flex-col items-center">
          {/* Text Section */}
