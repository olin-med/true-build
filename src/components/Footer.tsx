...
export default function Footer() {
  return (
    <footer className="text-[#fff6ed] bg-[#304F8C] py-24">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-4">
          ...
          <a
            ...
            className="text-[#fff6ed] hover:text-blue-500 transition-colors duration-300"
          >
            <FaFacebookF size={24} />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#fff6ed] hover:text-green-500 transition-colors duration-300"
          >
            <FaWhatsapp size={24} />
          </a>
          {/* Link para Facebook */}
          <a
            ...
            className='text-[#fff6ed] hover:text-red-700'>
            <FaEnvelope size={24} />
          </a>
          <a>
